...
#Region "PROCESSES"
    ...
    Private Sub processgrid_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles processgrid.KeyDown
        If e.KeyCode = Keys.Enter Then
            ...
            Me.pGrid_Path = processgrid(2, Me.processgrid.SelectedRows(0).Index).Value
...
#End Region
    ...
    Private Sub admanagement_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles admanagement.Click
        ...
        Me.GO_Button.Select()
    End Sub
    Private Sub ADMgmtLoader()
        ADmgmt.Show()
        ' add domain user info into admgmt form
        If Me.Label_User.Text.Contains("\") Then
            ADmgmt.txtSearch.Text = Me.Label_User.Text.Substring(Me.Label_User.Text.IndexOf("\") + 1)
            Dim domain As String = Me.Label_User.Text.Substring(0, Me.Label_User.Text.IndexOf("\")).ToUpper
            For Each row As Data.DataRow In ADmgmt.domainList.Rows
                If row(0).ToString.ToUpper = domain Then
                    ADmgmt.DomainSelect.Text = domain
                    Exit For
                End If
            Next
        End If
