...
#End Region
    ...
    Public Property Username() As String
        Get
            If _found Then
                If String.IsNullOrEmpty(_username) Then
                    Return Nothing
                Else
                    Return EncryptText.DecryptText(_username)
                End If
            Else
                Return Nothing
            End If
        ...
        Set(ByVal value As String)
            If String.IsNullOrEmpty(value) Then
                _username = Nothing
            Else
                _username = EncryptText.EncryptText(value)
            End If
        End Set
    End Property
    ...
    Public Property Password() As String
        Get
            If _found Then
                If String.IsNullOrEmpty(_password) Then
                    Return Nothing
                Else
                    Return EncryptText.DecryptText(_password)
                End If
            Else
                Return Nothing
            End If
        ...
        Set(ByVal value As String)
            If String.IsNullOrEmpty(value) Then
                _password = Nothing
            Else
                _password = EncryptText.EncryptText(value)
            End If
        End Set
    End Property
    ...
    Protected Friend Sub SaveCustomDomainInfo(ByVal Domain As String, ByVal dnsDomain As String, ByVal DomainController As String, ByVal User As String, ByVal Passwd As String)
        ...
        If Not String.IsNullOrEmpty(Passwd) Then Passwd = EncryptText.EncryptText(Passwd)
