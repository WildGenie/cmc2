...
Source: "C:\DATA\dotnet projects\cmc\trunk\admgmt\bin\ADMgmt.exe"; DestDir: "{app}\Files"; Flags: ignoreversion
Source: "C:\DATA\dotnet projects\cmc\trunk\netdetect\bin\Release\NetDetect.exe"; DestDir: "{app}\Files"; Flags: ignoreversion
Source: "C:\DATA\dotnet projects\cmc\trunk\perfmonitor\bin\Release\PerfMonitor.exe"; DestDir: "{app}\Files"; Flags: ignoreversion
Source: "C:\DATA\dotnet projects\cmc\trunk\remoteregedit\bin\Release\RemReg.exe"; DestDir: "{app}\Files"; Flags: ignoreversion
Source: "C:\DATA\dotnet projects\cmc\trunk\admgmt\bin\Interop.ActiveDs.dll"; DestDir: "{app}\Files"; Flags: ignoreversion
Source: "C:\DATA\dotnet projects\cmc\trunk\admgmt\bin\Interop.TSUSEREXLib.dll"; DestDir: "{app}\Files"; Flags: ignoreversion
...
Source: "C:\DATA\dotnet projects\cmc\trunk\perfmonitor\Resources\ZedGraph.dll"; DestDir: "{app}\Files"; Flags: ignoreversion
...
Name: "{group}\Performance Monitor"; Filename: "{app}\files\perfmonitor.exe"
